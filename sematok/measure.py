...
def measure_compression(
    ...
    return {
        ...
        "compression_ratio": total_savings / total_original if total_original else 0,
        "avg_macros_per_file": total_macros / len(sample) if sample else 0,
    }
...
def main():
    ...
    print(f"Total macros inserted: {results['total_macros']:,}")
